...
public class ReservationsTest {
    ...
    public void testConstructorAndGetters() {
        ...
        Reservations r = new Reservations("1", "U001", "S001", seats, "2025-11-10", "19:00", 40.0);
    ...
    public void testSetterUpdateValues() {
        Reservations r = new Reservations("2", "U002", "S002", Arrays.asList("B1"), "2025-12-01", "18:30", 15.0);
    ...
    public void testToStringFormat() {
        Reservations r = new Reservations("4", "U004", "S004", Arrays.asList("C1", "C2"), "2025-12-10", "17:00", 25.0);
        String expected = "4,U004,S004,C1|C2,2025-11-10,17:00,25.0";
    ...
    public void testNumSeatsConsistency() {
        Reservations r = new Reservations("7", "U007", "S007", Arrays.asList("E1"), "2025-12-25", "20:00", 20.0);
    ...
    public void testEmptySeatsFromLine() {
        ...
        assertEquals(0, r.getNumSeats());
        assertTrue(r.getSeatIDs().isEmpty() || r.getSeatIDs() == null);
    ...
    public void testInvalidInputHandling() {
        String[] badLines = {
                "", // completely empty
                ",,,,," , // all fields empty
                "10,U010,S010,A1|A2,2025-12-01,19:00,notanumber" // invalid price
        };
        for (String badLine : badLines) {
            try {
                Reservations r = new Reservations(badLine);
                assertNotNull(r); // Should create object without crashing
            } catch (Exception e) {
                fail("Reservations constructor should not crash on bad input: " + e.getMessage());
            }
        }
    }
    ...
    public void testTotalPriceEdgeCases() {
        Reservations r = new Reservations("9", "U009", "S009", Arrays.asList("F1"), "2025-12-15", "19:00", -50.0);
        assertEquals(-50.0, r.getTotalPrice(), 0.001);
    ...
    public void testPersistentDataStringMatch() {
        ...
        Reservations original = new Reservations("6", "U006", "S006", Arrays.asList("D1", "D2"), "2025-12-20", "19:30", 30.0);
